...
@client.command()
async def pun(ctx):
    puns = ['I got fired from the calendar factory, just for taking a day off.', 'What’s the best thing about Switzerland? Well, the flag is a big plus.', 'What are windmills’ favorite genre of music? They’re big metal fans.', 'I love whiteboards. They’re re-markable.', 'The machine at the coin factory     just suddenly stopped working. It doesnt make any cents.', 'I was worried about being in a long-distance relationship. But so far so good.', 'I quit my job at the donut factory. I was fed up with the hole business.', "It's not the man didn't know how to juggle,he just didn't have the balls to do it!"]
    await ctx.send(f'Pun: {random.choice(puns)}')

client.run('Nzk5NjkxNTk2MTYwODI3NDAy.YAHQ1g.g3paobq7duFWQi08LT1Xl7X9SWI')
